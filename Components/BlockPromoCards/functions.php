        ...
        'sub_fields' => [
            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        'label' => __('Link Label', 'flynt'),
                        'instructions' => __('Optional. Adds a link at the bottom of the card.', 'flynt'),
                        'name' => 'cardLinkLabel',
                        'type' => 'text',
                    ...
                    [
                        ...
                        'instructions' => __('Supports full URLs (https://example.com), internal paths (/about), anchors (#free-estimate), or protocol URLs (tel:1231231234).', 'flynt'),
                        'name' => 'cardLinkUrl',
                        'type' => 'text',
                        'required' => 0,
                        'wrapper' => ['width' => '34'],
